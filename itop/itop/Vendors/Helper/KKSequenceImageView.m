...
- (NSArray *)animationImages{
    ...
    NSString *sampleBundlePath = [[NSBundle mainBundle] pathForResource:@"loadingGif.bundle" ofType:nil];
    NSBundle *sampleBundle = [NSBundle bundleWithPath:sampleBundlePath];
    /** 加载图片 */
    for (int i = 1; i <= 71; i++)
    {
        NSString *path = [sampleBundle pathForResource:[NSString stringWithFormat:@"logo_000%d",i] ofType:@"png"];
        if (path.length) {
