...
-(NSMutableArray *)configurationCompenyMenu:(InfomationModel *)info{
    ...
    [sectionArray addObject:[self setupLeaveDetailWithLeaveDetailTitle:@"企业简称" content:info.other_info.short_name isEditor:YES sendKey:@"Short_name" pickViewType:PickViewTypeEdit]];
...
-(NSMutableArray *)configurationMarktingMenu:(InfomationModel *)info{
    ...
    [sectionArray addObject:[self setupLeaveDetailWithLeaveDetailTitle:@"简介" content:info.other_info.remark isEditor:YES sendKey:@"Remark" pickViewType:PickViewTypeIntroduction]];
    return sectionArray;
}
