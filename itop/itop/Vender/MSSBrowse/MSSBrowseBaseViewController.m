...
- (instancetype)initWithBrowseItemArray:(NSArray *)browseItemArray currentIndex:(NSInteger)currentIndex
{
    ...
    if(self)
    {
        ...
        [_browseItemArray addObjectsFromArray: browseItemArray];
...
- (void)viewDidLoad
{
    ...
    self.navigationController.navigationBar.backgroundColor = PYBarTintColor;
    ...
    view.backgroundColor = PYBarTintColor;
...
//        if (self.navigationController.navigationBar.py_y == [UIApplication sharedApplication].statusBarFrame.size.height) {
//            [[UIApplication sharedApplication]setStatusBarHidden:NO
//                                                                withAnimation:UIStatusBarAnimationFade];
//        } {
//           
...
-(void)trashDidClicked {
    ...
    if ([self.delegate respondsToSelector:@selector(deleteImageIndex:)]) {
        ...
        [self.delegate deleteImageIndex:_currentIndex];
