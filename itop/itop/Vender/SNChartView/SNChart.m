...
- (void)startDraw {
    ...
    if (_chartStyle == SNChartStyleLine) {
        ...
        self.myScrollView.contentSize = CGSizeMake(ScreenWidth - 24, 0);
        CGRect frame = self.chartLine.frame;
        frame.size.width = ScreenWidth - 24;
...
- (void)showInView:(UIView *)view {
    [self startDraw];
    self.bounds = CGRectMake(0, 0, view.bounds.size.width, view.bounds.size.height);
